...
function footer(depth, makeLink = link) {
  return `<footer class="site-footer"><p>${escapeHtml(site.name)}. Practical software for Android, WordPress, browser tools, and repo-backed products.</p><nav aria-label="Footer"><a href="${makeLink(depth, "apps/")}">Apps</a><a href="${makeLink(depth, "plugins/")}">Plugins</a><a href="${makeLink(depth, "admin/")}">Admin</a><a href="${makeLink(depth, "privacy/")}">Privacy</a><a href="${makeLink(depth, "terms/")}">Terms</a><a href="${makeLink(depth, "accessibility/")}">Accessibility</a></nav></footer>`;
}
