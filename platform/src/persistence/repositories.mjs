...
export function createRepositories() {
  return {
    ...
    betaEnrollmentEvents: new GenericRepository("beta_enrollment_events"),
    betaTrackSyncs: new GenericRepository("beta_track_syncs"),
    betaDataRequests: new GenericRepository("beta_data_requests"),
    ...
    readinessEvidence: new GenericRepository("readiness_evidence"),
    securityFindings: new GenericRepository("security_findings"),
